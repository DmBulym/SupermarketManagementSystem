...
public class GUI{
	...
	GUI() throws Exception{
		...
		btnUserSignupPanel = new JButton("Sign Up");
		...
		btnUserLoginAttempt.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(users.illegalUserTextInput(textfieldUsername.getText()) || users.illegalUserTextInput(String.valueOf(passwordFieldUser.getPassword()))){
					...
					labelProfileUsername = new JLabel("User Name");
					...
					labelProfileMobileNo = new JLabel("Phone Number");
					...
					// user logout button
					btnUserLogout = new JButton("Log Out");
						...
						public void actionPerformed(ActionEvent arg0) {
							for(int i=0; i<=orders.newOrderID; i++){
								if(checkboxUserOrders[i].isSelected()){
									...
									JLabel labelUsername = new JLabel("User Name: " + orders.username[checkedOrderID]);
		...
		btnUserSignupPanel.addActionListener(new ActionListener(){
			...
			@Override
			public void actionPerformed(ActionEvent arg0) {
				System.out.println("User sign up panel");
				// elements
				...
				labelUserSignup = new JLabel("Sign Up");
				...
				labelSignupUsername = new JLabel("User Name ");
				...
				labelSignupMobileNumber = new JLabel("Phone Number");
				...
				btnUserSignupAttempt = new JButton("Sign Up");
				...
				btnAdminLoginAtttempt.addActionListener(new ActionListener(){
					...
					public void actionPerformed(ActionEvent arg0) {	
						...
						if(!String.valueOf(passwordFieldAdmin.getPassword()).equals(ROOT_PASSWORD)){
							...
							labelAdminControlMobileNoHeader = new JLabel("Phone Number");
							...
							labelAdminOrderUsernameHeader = new JLabel("User Name");
